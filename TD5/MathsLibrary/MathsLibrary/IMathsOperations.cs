...
namespace MathsLibrary
{
    ...
    public interface IMathsOperations
    {
        ...
        [OperationContract]
        [WebInvoke(Method = "GET", UriTemplate = "Mult?x={value1}&y={value2}", BodyStyle = WebMessageBodyStyle.Wrapped, ResponseFormat = WebMessageFormat.Json)]
        int Multiply(int value1, int value2);

        [OperationContract]
        [WebInvoke(Method = "GET", UriTemplate = "Div?x={value1}&y={value2}", BodyStyle = WebMessageBodyStyle.Wrapped, ResponseFormat = WebMessageFormat.Json)]
